<template>
  <div id="hot" class="animate__animated animate__bounceIn">
    <div class="header">
      <div class="titleImg">
        <img :src="ThePaperVideoList.site.attrs.logo" alt="" style="width:50px;height:25px" />
      </div>
    ...
    <div class="main">
      <h3 v-show="!ThePaperVideoList.site.subs[0].items.length" class="loading">努力加载中...</h3>
      <ul class="hotList">
        <li
          v-for="(item, index) in ThePaperVideoList.site.subs[0].items.slice(
            currentIndex,
...
export default {
  ...
  computed: {
    ...mapState({
      ThePaperVideoList: state => state.anyknow.ThePaperVideoList
    })
  },
  methods: {

<template>
  <div id="hot" class="animate__animated animate__fadeIn">
    <div class="header">
      <div class="titleImg">
        <img :src="DeveloperTopList.site.attrs.logo" alt="" style="width:50px;height:25px" />
      </div>
    ...
    <div class="main">
      <h3 v-show="!DeveloperTopList.site.subs[0].items.length" class="loading">努力加载中...</h3>
      <ul class="hotList">
        <li
          v-for="(item, index) in DeveloperTopList.site.subs[0].items.slice(
            currentIndex,
        ...
        >
          ...
          <a :href="`https://toutiao.io/search?utf8=%E2%9C%93&q=${item.title}`" target="_blank" class="mainText">{{
            item.title
          }}</a>
...
export default {
  ...
  computed: {
    ...mapState({
      DeveloperTopList: state => state.anyknow.DeveloperTopList
    })
  },
  methods: {

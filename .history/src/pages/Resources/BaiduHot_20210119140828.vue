<template>
  ...
  <div id="hot" class="animate__animated animate__slideInLeft">
    <div class="header">
      <div class="titleImg">
        <img :src="BaiduNewsList.site.subs[0].attrs.logo" alt="" style="width:25px;height:25px" />
      </div>
      <span class="title">百度热点榜</span>
      <div @click="changeIndex(currentIndex, totalSize, pageSize)">
        <span class="change"><i class="iconfont icon-iconmore"></i>下一页</span>
      </div>
    </div>

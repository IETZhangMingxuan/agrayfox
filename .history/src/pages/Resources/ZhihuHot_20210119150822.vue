<template>
  <div id="hot" class="animate__animated animate__slideInLeft">
    <div class="header">
      <div class="titleImg">
        <img :src="ZhihuNewsList.site.attrs.logo" alt="" style="width:25px;height:25px" />
      </div>
    ...
    <div class="main">
      ...
      <ul class="hotWeiboList">
        ...
        >
          ...
          <a :href="`http://www.baidu.com/s?wd=${item.title}`" target="_blank" class="mainText">{{ item.title }}</a>

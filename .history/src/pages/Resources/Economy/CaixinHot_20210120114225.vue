<template>
  <div id="hot" class="animate__animated animate__bounceIn">
    <div class="header">
      <div class="titleImg">
        <img :src="CaixinNewsList.site.attrs.logo" alt="" style="width:50px;height:25px" />
      </div>
    ...
    <div class="main">
      <h3 v-show="!CaixinNewsList.site.subs[0].items.length" class="loading">努力加载中...</h3>
      <ul class="hotList">
        <li
          v-for="(item, index) in CaixinNewsList.site.subs[0].items.slice(
            currentIndex,
...
export default {
  ...
  computed: {
    ...mapState({
      CaixinNewsList: state => state.anyknow.CaixinNewsList
    })
  },
  methods: {

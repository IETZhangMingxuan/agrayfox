<template>
  <div id="news">
    ...
    <div class="recommend">{{yqdata.data.chinaTotal.today.confirm}}</div>
  </div>
</template>
<script>
export default {
    ...
    return {
      ...
      yqdata: {
        ...
        data: {
          ...
          lastUpdateTime: "2021-01-15 00:12:04",
          overseaLastUpdateTime: "2021-01-15 02:52:08"
        },
        timestamp: 1610653859937
      }
    };
  },
  methods: {

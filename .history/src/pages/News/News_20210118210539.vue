    ...
    <div class="recommend">
      ...
      <div class="carousel">
        <div class="block">
          ...
          >
            <el-carousel-item v-for="(item, index) in SportsNewsList.slice(0,11)" :key="index">
              <div class="picItem">
                <a :href="item.url" target="_blank"><img :src="item.picUrl"/></a>
                <span class="title">{{ item.title }}</span>
              </div>
            </el-carousel-item>
             <el-carousel-item v-for="(item, index) in SportsNewsList.slice(3, 4)" :key="index">
              <div class="picItem">
                <a :href="item.url" target="_blank"><img :src="item.picUrl"/></a>
                <span class="title">{{ item.title }}</span>
              </div>
            </el-carousel-item>
             <el-carousel-item v-for="(item, index) in SportsNewsList.slice(2, 3)" :key="index">
              <div class="picItem">
                <a :href="item.url" target="_blank"><img :src="item.picUrl"/></a>
                <span class="title">{{ item.title }}</span>
              </div>

        ...
        <div class="main">
          <ul class="virusNavList">
            ...
            <li>
              ...
              <p style="color: #FFA352" class="total">{{ VirusNumList[0].desc.seriousCount }}</p>
              <p style="color: #FFA352" class="thanYesterday">
                <span style="color:#666">较昨日:</span>
            ...
            <li>
              ...
              <p style="color: #FFA352" class="total">{{ VirusNumList[0].desc.currentConfirmedCount }}</p>
              <p style="color: #FFA352" class="thanYesterday">
                <span style="color:#666">较昨日:</span>
            ...
            <li>
              ...
              <p style="color: #FFA352" class="total">{{ VirusNumList[0].desc.confirmedCount }}</p>
              <p style="color: #FFA352" class="thanYesterday">
                <span style="color:#666">较昨日:</span>
            ...
            <li>
              ...
              <p style="color: #FFA352" class="total">{{ VirusNumList[0].desc.deadCount }}</p>
              <p style="color: #FFA352" class="thanYesterday">
                <span style="color:#666">较昨日:</span>
            ...
            <li v-for="(item, index) in virusNav" :key="index" class="virusNav">
              ...
              <p style="color: #FFA352" class="total">{{ VirusNumList[0].desc.curedCount }}</p>
              <p style="color: #FFA352" class="thanYesterday">
                <span style="color:#666">较昨日:</span>

    ...
    <div class="recommend">
      ...
      <div class="carousel">
        ...
        <div class="textNews">
          ...
          <input @click="changeSportsNews(isSportsNewsShow,seeMoreOrNot)" type="button" v-model="seeMoreOrNot" class="seeMoreOrNot"/>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    changeSportsNews(isSportsNewsShow,seeMoreOrNot){
      if(this.isSportsNewsShow){
        console.log(this.isSportsNewsShow);
        console.log(this.seeMoreOrNot);
        this.isSportsNewsShow === true;
        this.seeMoreOrNot = '收起';

      }else if(!this.isSportsNewsShow){
        console.log(this.isSportsNewsShow);
        console.log(this.seeMoreOrNot);

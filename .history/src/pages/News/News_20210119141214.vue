    ...
    <div class="recommend">
        ...
        <div class="virusNews">
          ...
          <div class="newsMain">
            <ul class="virusNewsList">
              ...
              <li v-for="(p, index) in VirusNumList[0].news.slice(1, 2)" :key="index">
                <a :href="p.sourceUrl" target="_blank">{{ p.title }}</a>
                <p class="time">{{ p.pubDateStr }}</p>
              </li>
              <li v-for="(p, index) in VirusNumList[0].news.slice(2,3)" :key="index">
                <a :href="p.sourceUrl" target="_blank">{{ p.title }}</a>
                <p class="time">{{ p.pubDateStr }}</p>
              </li>
              <li v-for="(p, index) in VirusNumList[0].news.slice(0, 1)" :key="index">
                <a :href="p.sourceUrl" target="_blank">{{ p.title }}</a>
                <p class="time">{{ p.pubDateStr }}</p>
              </li>
              <li v-for="(p, index) in VirusNumList[0].news.slice(3,4)" :key="index">
                <a :href="p.sourceUrl" target="_blank">{{ p.title }}</a>
                <p class="time">{{ p.pubDateStr }}</p>
              </li>
            </ul>
      ...
      <div class="carousel">
        <div class="block">
          ...
          >
            <el-carousel-item v-for="(p, index1) in SportsNewsList.slice(0, 4)" :key="'my'+index1">
              <div class="picItem">

        ...
        <div class="main">
          <ul class="virusNavList">
            <li>
              ...
              <p style="color: #FFA352" class="thanYesterday">
            ...
            <li>
              ...
              <p style="color: #791618" class="thanYesterday">
                <span style="color:#666">较昨日:</span>
            ...
            <li>
              ...
              <p style="color: #E44A3D" class="thanYesterday">
                <span style="color:#666">较昨日:</span>
            ...
            <li>
              ...
              <p style="color: #A31D13" class="thanYesterday">
                <span style="color:#666">较昨日:</span>
          ...
          <div class="time">
            ...
            {{new Date(virusData.timestamp)}}
          </div>
        </div>
        <div class="virusNews">
          <div class="newsLine"></div>
          <div class="newsTitle" @click="test">
            最新疫情新闻
          </div>
          <div class="newsMain">
...
export default {
  ...
  methods: {
    ...
    test(virusData){
      console.log(moment(virusData.timestamp).format('lll'));
      console.log(moment(virusData.timestamp).endOf('day').fromNow());
    }
  },
  computed: {
    ...mapState({

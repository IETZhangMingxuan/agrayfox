<template>
  <div id="news">
    ...
    <div class="recommend">
      ...
      <div class="carousel">
        <div class="block">
          <el-carousel trigger="click" height="150px" autoplay="true" interval="4000">
            <el-carousel-item v-for="(item,index) in SportsNewsList" :key="index">
              <img class="small" :src="item.picUrl"></img>
            </el-carousel-item>
          </el-carousel>
        </div>
      </div>

        ...
        <div class="main">
          <ul class="virusNavList">
            <li>
              ...
              <p style="color: #FFA352" class="thanYesterday" v-show="VirusNumList[0].desc.suspectedIncr">
            ...
            <li>
              ...
              <p style="color: #791618" class="thanYesterday" v-show="VirusNumList[0].desc.suspectedIncr">
                <span style="color:#666">较昨日:</span>
            ...
            <li>
              ...
              <p style="color: #E44A3D" class="total">{{ VirusNumList[0].desc.currentConfirmedCount }}</p>
              <p style="color: #E44A3D" class="thanYesterday" v-show="VirusNumList[0].desc.suspectedIncr">
                <span style="color:#666">较昨日:</span>
            ...
            <li>
              ...
              <p style="color: #A31D13" class="thanYesterday" v-show="VirusNumList[0].desc.suspectedIncr">
                <span style="color:#666">较昨日:</span>
            ...
            <li>
              ...
              <p style="color: #333" class="thanYesterday" v-show="VirusNumList[0].desc.suspectedIncr">
                <span style="color:#666">较昨日:</span>
            ...
            <li>
              ...
              <p style="color: #34AA70" class="thanYesterday" v-show="VirusNumList[0].desc.suspectedIncr">
                <span style="color:#666">较昨日:</span>

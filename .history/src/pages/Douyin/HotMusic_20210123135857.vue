  ...
  <div id="hotmusic">
    ...
    <div class="infinite-list-wrapper" style="overflow:auto">
      <ul class="list" v-infinite-scroll="load" infinite-scroll-disabled="disabled">
        <li v-for="(i, index) in DouyinMusicList" class="list-item" :key="index">
          <div class="musicImg">
          ...
          <div class="musicAuthor">
            <span
              ><a
                :href="
                  `https://music.163.com/#/search/m/?s=${i.author}&type=100`
                "
                target="_blank"
                >{{ i.author }}</a
              ></span
          ...
          <div class="musicHref">
            <a
              :href="
                `https://music.163.com/#/search/m/?s=${i.title}&type=1`
              "
              target="_blank"
              >{{ i.title }}</a
            >
...
#hotmusic {
  ...
  .infinite-list-wrapper {
    ...
    .list {
      ...
      .list-item:hover .musicHref {
        text-decoration: underline;
      }
      .list-item:hover .musicAuthor {
        text-decoration: underline;
      }
    }
    /* 设置滚动条样式 */

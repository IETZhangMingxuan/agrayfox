<template>
  <div id="kaiyan">
    ...
    <div class="videoListWrapper">
      ...
      <button @click="getKYVideoList(playUrl, playImg, videoTitle)">发送动态Axios请求</button>
      <ul class="videoList">
        <li
      ...
      <button
        ...
        @click="getKYVideoList(this.playUrl, this.playImg, this.videoTitle)"
      >
        换一批
      </button>
    </div>
...
export default {
  data() {
    return {
      ...
      /* 视频播放地址 */
      playUrl:
        "http://baobab.kaiyanapp.com/api/v1/playUrl?vid=129929&resourceType=video&editionType=default&source=aliyun&playUrlType=url_oss&udid=e686f5856bdf4d48b77b1220abedbb48b5cf1035",
      playImg:
        "http://img.kaiyanapp.com/bce6343db360b1c614db8069bc31d5a7.jpeg?imageMogr2/quality/60/format/jpg",
      videoTitle: "泪目预警！新海诚动画短片「来自谁的凝望」",
      KYVideoList: []
    };
  },
  methods: {
    ...
    async getKYVideoList(playUrl, playImg, videoTitle) {
    ...
    async created() {
      console.log("我要发送请求了");  
      getKYVideoList(playUrl, playImg, videoTitle);
      console.log("我发送完请求了");  
    }
  }
};

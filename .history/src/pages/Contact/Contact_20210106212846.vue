      ...
      <div class="publish">
        ...
        <form action="https://formspree.io/f/myyblyqp" method="POST" class="mainForm" id="my-form">
          ...
          <input
            ...
            autocomplete="off"
          />
          <input type="text" name="main" class="main" placeholder="在此处输入留言内容">
          <button id="my-form-button" class="submit" @click="sendEmail">提交评论</button>
          <!-- <input type="button" value="提交评论" class="submit" @click="sendEmail"/> -->
          <p id="my-form-status" style="background:#eaeaea;margin-top:20px;margin-bottom:20px;padding:10px;">待发送</p>
        </form>
      </div>
      <!-- 所有留言区 -->
...
<script>
    window.addEventListener("DOMContentLoaded", function () {
        ...
        function success() {
            ...
            status.innerHTML = "提交成功!待审核后显示!";
        }

        function error() {
            status.innerHTML = "出错了!请检查一下邮箱格式是否正确";
        }

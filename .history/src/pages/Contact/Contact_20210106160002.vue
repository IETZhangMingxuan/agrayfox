    ...
    <div class="left">
      ...
      <div class="allContents">
        ...
        <div class="contents">
          <ul class="contentsList">
            <li v-for="(item, index) in contentsList.slice(currentIndex,currentIndex + pageSize)" :key="index">
      ...
      <div class="pagination">
        <el-pagination
          ...
          :page-sizes="[2, 3, 4, 5]"
          :page-size="3"
          :current-page="contentsList.length"
        ></el-pagination>
      </div>
    </div>
    <!-- 右侧站长信息及广告等  -->
...
export default {
  data() {
    return {
      ...
      currentIndex:0,
      /* 返回的总条数:不可修改 */
      totalSize: this.contentsList.length,
      /* 每页显示条数:可修改 */
      pageSize: 10
    };
  }

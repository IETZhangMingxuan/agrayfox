  ...
  <div id="contact">
    ...
    <div class="left">
      ...
      <div class="publish">
        ...
        <!-- 主要表单 -->
        <form action="https://www.maildock.ink/state/send/mail?posId=12a7d180bfef4ba2976a3311936c9073" method="POST" class="mainForm" id="my-form">
          <input
            type="text"
            name="name"
            class="name"
...
export default {
  ...
  methods: {
    ...
    async sendEmail(ev) {
      ...
      await axios({
        url: "https://www.maildock.ink/state/send/mail?posId=12a7d180bfef4ba2976a3311936c9073",
        method: "post",
        headers: {
  ...
  // mounted() {
  /* 测试验证码 */
  // this.verifyCode = new GVerity("v-container");
  // }
};
</script>
<style lang="less">

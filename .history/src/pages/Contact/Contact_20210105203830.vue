    ...
    <div class="left">
      ...
      <div class="publish">
        ...
        <form action="https://formspree.io/f/myyblyqp" method="POST" class="mainForm">
          ...
          <input type="email" name="_replyto" class="replyTo" placeholder="请输入邮箱" autocomplete="off"/>
          <textarea type="text" name="main" class="main" placeholder="请在此留言" />
          <input type="submit" value="提交" class="submit" />
        </form>
      </div>
      <!-- 所有留言区 -->
      <div class="allContents"></div>
    </div>
    <!-- 右侧站长信息及广告等  -->
    <div class="right">
      <!-- 站长信息 -->

  ...
  <div id="contact">
    ...
    <div class="right">
      ...
      <div class="myself">
        ...
        <div class="intro">
          <p class="first">你好,这里是灰狐,欢迎访问我的个人主页.博主是一名前端码农,设计爱好者,英文名是GrayFox,取自沾染上时间尘埃的雪狐.</p>
          <p class="second">我目前在魔都一家互联网公司供职,平时的爱好比较广泛,喜欢研究一些奇怪的新技术,喜欢读书写字写Bug,旅游运动养奶喵。如你所见,这是我的个人博客主页,每一行代码都是我亲手所敲,整个前端界面由我独自设计和开发,当前是1.0版本,后续会慢慢对网站进行更新。随时欢迎大家没事来逛逛,如果需要在网站里添加哪些功能或者发布广告都可以在左边评论区给我留言,留言在审核后会显示在下方留言板中,如果急需联系本人,也可以拨打本人的手机号码17611029327</p>
          <p class="third">P.S.诚招一个懂设计的UI妹子帮我改改图,有重谢!</p>
        </div>
      </div>
    </div>
  </div>

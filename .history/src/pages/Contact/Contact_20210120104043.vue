    ...
    <div class="right">
      ...
      <div class="myself animate__animated infinite animate__jackInTheBox">
        ...
        <div class="basicInfo">
          ...
          <a href="https://api.66mz8.com/api/qq.talk.php?qq=1628029199" style="text-decoration:none">
            <i class="iconfont icon-QQ1" style="font-size:1.5em;color:#666;padding-bottom:5px;margin-top:10px"></i>
          </a>
        </div>

  ...
  <div id="contact">
    ...
    <div class="left">
      ...
      <div class="publish">
        ...
        <!-- 主要表单 -->
        <form
          action="https://formspree.io/f/myyblyqp"
          method="POST"
          class="mainForm"
          id="my-form"
        >
...
export default {
  data() {
    return {
      contentsList: [{
          ...
          content: `蕾比是猪`,
          imgUrl:
            "http://m.qpic.cn/psc?/V10w2eNK08lVEK/45NBuzDIW489QBoVep5mcRiHFaQpEY2lQqc9Zjlcm4BLOtzcA8xBlQzXo9ylo7cTDQx77.5k2BojZ0GuDJLDP44cjgtQ4DQ*u774E7Tbm08!/b&bo=vAK8AgAAAAABFzA!&rf=viewer_4",
          isvip: true,
          vip: "会长",
          time: "2021年1月8日 22:56分",
          color: "orange"
        },{
          id: 15,
          name: "蕾比",
          content: `我是一只可爱的猪`,
          imgUrl:
            "https://m.qpic.cn/psc?/V10w2eNK08lVEK/ruAMsa53pVQWN7FLK88i5plXQ5yUIZzTQfr2iWJre63jkHFyXMk9hT0zexG0SvpXCQhvTayO8mNhLC5RP1by1YQjlv5EH5jSfKygt8FC08o!/mnull&bo=vAK8AgAAAAABByA!&rf=photolist&t=5",
          isvip: true,
          vip: "一只猪",
          time: "2021年1月8日 22:49分",
          color: "red"
        },
        {
          id: 14,
  ...
  methods: {
    ...
    async sendEmail(ev) {
      ...
      await axios({
        url: "https://formspree.io/f/moqpydyd",
        method: "post",
        headers: {

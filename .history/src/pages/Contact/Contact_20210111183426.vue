<template>
  <div id="contact">
    ...
    <div class="left">
      ...
      <!-- 所有留言区 -->
      <div class="allContents animate__animated infinite animate__flipInX">
        <i class="iconfont icon-liuyan2"></i>
        <div class="title">
          <span class="animate__animated animate__bounce">留言板</span>
        ...
        <div class="contents">
          <ul class="contentsList">
            <li
              ...
              :key="index"
              class="animate__animated infinite animate__flipInX"
            >

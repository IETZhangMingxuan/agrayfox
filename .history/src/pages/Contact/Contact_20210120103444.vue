    ...
    <div class="right">
      ...
      <div class="myself animate__animated infinite animate__jackInTheBox">
        ...
        <div class="basicInfo">
          ...
          <p class="hi">个人介绍</p>
          <p class="myWebsite">给我一个接口,还你一个世界</p>
          <a target="_blank" href="http://wpa.qq.com/msgrd?V=1&Uin=1628029199&Exe=QQ&Site=http://blog.csdn.net/alexjjf&Menu=No">
<img border="0" SRC= http://wpa.qq.com/pa?p=1:15193512:1 alt="给我发消息"></a>
          <a href="https://api.66mz8.com/api/qq.talk.php?qq=1628029199"
            ><img
              src="http://pub.idqqimg.com/qconn/wpa/button/button_old_11.gif"
              alt=""
              class="contactMeImg"
          /></a>
        </div>
        ...
        <div class="intro">
          <p class="first">
            你好,这里是灰狐,欢迎访问我的个人主页.博主是一名前端码农,设计爱好者,中文名是张明轩,英文名是GrayFox,取自沾染上世间尘埃的白狐.
          </p>
          <p class="second">

    ...
    <div class="right">
      ...
      <div class="myself">
        ...
        <div class="intro">
          ...
          <p class="second">
            我目前在魔都一家互联网公司供职,平时的爱好比较广泛,喜欢研究一些奇怪的新技术,喜欢读书写字写Bug,旅游运动养奶喵。如你所见,这是我的个人博客主页,整个前端界面由我独自设计和开发,当前是Version 1.0版本,后续会慢慢对网站进行定期更新,也会开发该网站的小程序版本。随时欢迎大家来逛逛,如果需要在网站里添加哪些功能或者发布广告或者提供一些建议都可以在左边评论区给我留言,如果急需联系本人,也可以通过上方的联系方式立刻与我联系.我还可以帮忙给需要的人自助建站,配置服务器环境.
          </p>
        </div>
      </div>
    </div>

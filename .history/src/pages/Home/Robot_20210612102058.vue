  ...
  <div id="robot" :class="{ minShow: isMinShow }">
    <div class="header" v-show="headerIsShow">
      ...
      <div class="control">
        ...
        <i class="iconfont icon-zuidahua" v-show="isMinShow" @click="zuidahua"></i>
      </div>
    </div>
      ...
      <div class="wrapper">
        <div class="talkList clearfix">
          <p
            ...
            :key="index"
            :class="{ isme: index % 2 == 0, isyou: index % 2 == 1 && talk !== undefined, isair: talk == undefined }"
          >
            {{ talk }}
          </p>
        </div>

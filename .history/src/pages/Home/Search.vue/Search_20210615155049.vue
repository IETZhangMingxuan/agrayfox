...
#search {
  ...
  .bgGif {
    ...
    position: absolute;
    top:0;
    background: linear-gradient(to bottom right, #409eef, #eaeaea);
    // background: url(https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fdns2.fiitotech.com%2Fthumb%2Fs%2FtcSf445jUw.jpg%3Fc%3D1975020603&refer=http%3A%2F%2Fdns2.fiitotech.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1626334860&t=9ad076d47ebbcb15ef55c6d5a4dabeae);
    .bg-bubbles {
      position: absolute;
      // 使气泡背景充满整个屏幕
      top: 0;

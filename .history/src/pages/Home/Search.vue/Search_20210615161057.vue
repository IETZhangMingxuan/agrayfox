<template>
  <div id="search" class="animate__animated animate__fadeIn">
    <div class="bgGif">
      <ul class="bg-bubbles">
        <li v-for="i in 20" :key="i">{{ item }}</li>
      </ul>
    </div>
...
#search {
  ...
  .bgGif {
    ...
    background:url(https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fimage.biaobaiju.com%2Fuploads%2F20190508%2F18%2F1557312439-pkdIfAQqvx.jpg&refer=http%3A%2F%2Fimage.biaobaiju.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=jpeg?sec=1626336649&t=97b5962ac2c22ccf41e4fc8a110d2748) no-repeat;
    .bg-bubbles {
      position: absolute;
      // 使气泡背景充满整个屏幕
      top: 0;
